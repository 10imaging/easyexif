...
std::string tr_ComponentsConfiguration(unsigned char cc[4]) {
  ...
  for (int i=0; i<4; i++) {
    switch (cc[i]) {
      case 1 : rval.append("Y "); break;
      case 2 : rval.append("Cb "); break;
      case 3 : rval.append("Cr "); break;
      case 4 : rval.append("R "); break;
      case 5 : rval.append("G "); break;
      case 6 : rval.append("B "); break;
      case 0 :
      default : rval.append(""); break;
    }
  }
  return rval;
}
